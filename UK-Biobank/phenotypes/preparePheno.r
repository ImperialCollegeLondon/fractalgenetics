...
## libraries ####
#################
options(import.path=c("~/analysis/fractalgenetics/fractal-analysis-processing",
                      "~/hannah/projects"))
options(bitmapType = 'cairo', device = 'pdf')

modules::import('ggplot2', attach=TRUE)
modules::import('GGally', attach=TRUE)
optparse <- modules::import('optparse')
ukbtools <- modules::import('ukbtools')
related <- modules::use('GWAS/relatedness')
autofd <- modules::use('fracDecimate')
smooth <- modules::use('utils/smoothAddR2')

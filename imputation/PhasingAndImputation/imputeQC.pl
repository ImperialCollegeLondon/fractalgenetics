...
foreach  my $chr (1..22, "X") {
    ...
    open (OUT_NUMBERS, ">$outdir/chr$chrStr"."_numbers.txt") or die "Can't write to filehandle $outdir/chr$chrStr"."_numbers.txt, reason: $!";
    open (OUT_DATA, ">$outdir/chr$chrStr"."_data.txt") or die "Can't write to filehandle $outdir/chr$chrStr"."_data.txt, reason: $!";
